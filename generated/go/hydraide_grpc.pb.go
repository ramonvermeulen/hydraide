...
const (
	HydraideService_Heartbeat_FullMethodName               = "/hydraidepb.HydraideService/Heartbeat"
	HydraideService_Lock_FullMethodName                    = "/hydraidepb.HydraideService/Lock"
	HydraideService_Unlock_FullMethodName                  = "/hydraidepb.HydraideService/Unlock"
	HydraideService_RegisterSwamp_FullMethodName           = "/hydraidepb.HydraideService/RegisterSwamp"
	HydraideService_DeRegisterSwamp_FullMethodName         = "/hydraidepb.HydraideService/DeRegisterSwamp"
	HydraideService_Set_FullMethodName                     = "/hydraidepb.HydraideService/Set"
	HydraideService_Get_FullMethodName                     = "/hydraidepb.HydraideService/Get"
	HydraideService_GetAll_FullMethodName                  = "/hydraidepb.HydraideService/GetAll"
	HydraideService_GetByIndex_FullMethodName              = "/hydraidepb.HydraideService/GetByIndex"
	HydraideService_ShiftExpiredTreasures_FullMethodName   = "/hydraidepb.HydraideService/ShiftExpiredTreasures"
	HydraideService_Destroy_FullMethodName                 = "/hydraidepb.HydraideService/Destroy"
	HydraideService_Delete_FullMethodName                  = "/hydraidepb.HydraideService/Delete"
	HydraideService_Count_FullMethodName                   = "/hydraidepb.HydraideService/Count"
	HydraideService_IsSwampExist_FullMethodName            = "/hydraidepb.HydraideService/IsSwampExist"
	HydraideService_IsKeyExist_FullMethodName              = "/hydraidepb.HydraideService/IsKeyExist"
	HydraideService_SubscribeToEvents_FullMethodName       = "/hydraidepb.HydraideService/SubscribeToEvents"
	HydraideService_SubscribeToInfo_FullMethodName         = "/hydraidepb.HydraideService/SubscribeToInfo"
	HydraideService_Uint32SlicePush_FullMethodName         = "/hydraidepb.HydraideService/Uint32SlicePush"
	HydraideService_Uint32SliceDelete_FullMethodName       = "/hydraidepb.HydraideService/Uint32SliceDelete"
	HydraideService_Uint32SliceSize_FullMethodName         = "/hydraidepb.HydraideService/Uint32SliceSize"
	HydraideService_Uint32SliceIsValueExist_FullMethodName = "/hydraidepb.HydraideService/Uint32SliceIsValueExist"
	HydraideService_IncrementInt8_FullMethodName           = "/hydraidepb.HydraideService/IncrementInt8"
	HydraideService_IncrementInt16_FullMethodName          = "/hydraidepb.HydraideService/IncrementInt16"
	HydraideService_IncrementInt32_FullMethodName          = "/hydraidepb.HydraideService/IncrementInt32"
	HydraideService_IncrementInt64_FullMethodName          = "/hydraidepb.HydraideService/IncrementInt64"
	HydraideService_IncrementUint8_FullMethodName          = "/hydraidepb.HydraideService/IncrementUint8"
	HydraideService_IncrementUint16_FullMethodName         = "/hydraidepb.HydraideService/IncrementUint16"
	HydraideService_IncrementUint32_FullMethodName         = "/hydraidepb.HydraideService/IncrementUint32"
	HydraideService_IncrementUint64_FullMethodName         = "/hydraidepb.HydraideService/IncrementUint64"
	HydraideService_IncrementFloat32_FullMethodName        = "/hydraidepb.HydraideService/IncrementFloat32"
	HydraideService_IncrementFloat64_FullMethodName        = "/hydraidepb.HydraideService/IncrementFloat64"
)
...
type HydraideServiceClient interface {
	...
	SubscribeToEvents(ctx context.Context, in *SubscribeToEventsRequest, opts ...grpc.CallOption) (HydraideService_SubscribeToEventsClient, error)
	...
	SubscribeToInfo(ctx context.Context, in *SubscribeToInfoRequest, opts ...grpc.CallOption) (HydraideService_SubscribeToInfoClient, error)
...
func (c *hydraideServiceClient) SubscribeToEvents(ctx context.Context, in *SubscribeToEventsRequest, opts ...grpc.CallOption) (HydraideService_SubscribeToEventsClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	...
	x := &hydraideServiceSubscribeToEventsClient{ClientStream: stream}
...
type HydraideService_SubscribeToEventsClient interface {
	Recv() (*SubscribeToEventsResponse, error)
	grpc.ClientStream
}

type hydraideServiceSubscribeToEventsClient struct {
	grpc.ClientStream
}

func (x *hydraideServiceSubscribeToEventsClient) Recv() (*SubscribeToEventsResponse, error) {
...
func (c *hydraideServiceClient) SubscribeToInfo(ctx context.Context, in *SubscribeToInfoRequest, opts ...grpc.CallOption) (HydraideService_SubscribeToInfoClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &HydraideService_ServiceDesc.Streams[1], HydraideService_SubscribeToInfo_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &hydraideServiceSubscribeToInfoClient{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type HydraideService_SubscribeToInfoClient interface {
	Recv() (*SubscribeToInfoResponse, error)
	grpc.ClientStream
}

type hydraideServiceSubscribeToInfoClient struct {
	grpc.ClientStream
}

func (x *hydraideServiceSubscribeToInfoClient) Recv() (*SubscribeToInfoResponse, error) {
...
type HydraideServiceServer interface {
	...
	//
	// 💡 You can use this to completely replace traditional polling or cron-based checks.
	SubscribeToEvents(*SubscribeToEventsRequest, HydraideService_SubscribeToEventsServer) error
	// SubscribeToInfo allows clients to subscribe to the **size** of a given swamp.
	//
	// Whenever the number of treasures changes in the swamp (insert, delete, expire),
	// the client receives a realtime update of the current element count.
	...
	//
	// ⚡ Events are sent immediately upon any change to the number of elements.
	SubscribeToInfo(*SubscribeToInfoRequest, HydraideService_SubscribeToInfoServer) error
	// Uint32SlicePush adds one or more uint32 values to one or more uint32 slices stored in a swamp.
	//
	// 💡 HydrAIDE automatically ensures that each value is unique within the slice.
	// If a number already exists, it will be ignored – no duplicates are ever stored.
...
// UnimplementedHydraideServiceServer must be embedded to have forward compatible implementations.
...
func (UnimplementedHydraideServiceServer) SubscribeToEvents(*SubscribeToEventsRequest, HydraideService_SubscribeToEventsServer) error {
	return status.Errorf(codes.Unimplemented, "method SubscribeToEvents not implemented")
}
func (UnimplementedHydraideServiceServer) SubscribeToInfo(*SubscribeToInfoRequest, HydraideService_SubscribeToInfoServer) error {
...
func _HydraideService_SubscribeToEvents_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(HydraideServiceServer).SubscribeToEvents(m, &hydraideServiceSubscribeToEventsServer{ServerStream: stream})
}

type HydraideService_SubscribeToEventsServer interface {
	Send(*SubscribeToEventsResponse) error
	grpc.ServerStream
}

type hydraideServiceSubscribeToEventsServer struct {
	grpc.ServerStream
}

func (x *hydraideServiceSubscribeToEventsServer) Send(m *SubscribeToEventsResponse) error {
...
func _HydraideService_SubscribeToInfo_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(HydraideServiceServer).SubscribeToInfo(m, &hydraideServiceSubscribeToInfoServer{ServerStream: stream})
}

type HydraideService_SubscribeToInfoServer interface {
	Send(*SubscribeToInfoResponse) error
	grpc.ServerStream
}

type hydraideServiceSubscribeToInfoServer struct {
	grpc.ServerStream
}

func (x *hydraideServiceSubscribeToInfoServer) Send(m *SubscribeToInfoResponse) error {
	return x.ServerStream.SendMsg(m)
}
...
var HydraideService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "hydraidepb.HydraideService",
