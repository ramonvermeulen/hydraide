...
type HydraServiceClient interface {
	...
	//
	// 💡 Hydra stores the value using its **actual underlying type** without upcasting,
	...
	//
	// ⚠️ Hydra creates index structures on-demand in memory when this method is called.
	...
	//
	// 💡 Hydra automatically ensures that each value is unique within the slice.
